 ...
 * @since 1.8
 */
final class XeFlowTest {

    @Test
    void manipulatesWithBindings() throws Exception {
        ...
        MatcherAssert.assertThat(
            "Flow should create bindings with correct names and types",
    ...
    void avoidsDuplicateBindings() throws Exception {
        ...
        MatcherAssert.assertThat(
            "Flow should avoid creating duplicate bindings with same name and type",
            XhtmlMatchers.xhtml(new Xembler(dirs).xml()),
            XhtmlMatchers.hasXPaths(
